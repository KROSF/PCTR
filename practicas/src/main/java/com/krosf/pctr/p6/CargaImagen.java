...
public class CargaImagen {
  ...
  /**
   * Carga una imagen en una matriz. La imagen es convertida automáticamente a una escala de niveles
   * de grises [0-255].
   *
   ...
   *
   * @param matriz Cada celda de la matriz representa un pixel de la imagen, codificado en 256
   *     niveles de grises [0-255].
  ...
  public static void guardar(int[][] matriz, String fichero) throws IOException {
    ...
    BufferedImage imagen =
        new BufferedImage(matriz[0].length, matriz.length, BufferedImage.TYPE_4BYTE_ABGR);
  ...
  public static void main(String[] args) throws IOException {
    ...
    ConvertirAGris(
        "/Users/krosf/vscode/PCTR/practicas/src/main/java/com/krosf/pctr/p6/uca.png",
        "/Users/krosf/vscode/PCTR/practicas/src/main/java/com/krosf/pctr/p6/uca_gris.png");
